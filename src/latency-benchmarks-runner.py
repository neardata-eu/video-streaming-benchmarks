...
if __name__ == "__main__":
    ...
    for num_writers_and_streams in [1]:
        for num_readers_per_stream in [1]:
            for pravega_buffer_size in [1024]:
                for video_height, video_width in [(600, 800)]:
                    for video_fps in [30]:
                        for video_bitrate_kbps in [5000]:
                            for reader_sleep_seconds in [5.0]:
                                try:
                                    ...
                                    command = ["python", directory_path + "latency-experiments-setup.py",
                                    ...
                                    command = ["python", directory_path + "download-latency-logs.py"]
                                    subprocess.run(command, check=True)
